        ...
        try {
            ...
            const response = await axios.get(
                "https://api.zetsu.xyz/api/xdash",
                {
                    params: {
                        query: query,
                        apikey: config.xdashApiKey // ✅ From config.json!
                    },
                    timeout: 25000,
            ...
            if (!answer || answer.length < 5) throw new Error("Invalid response");
            
            api.unsendMessage(loadingMsg.messageID);
            api.sendMessage(`⚡ **XDash AI**\n━━━━━━━━━━━━━━━━\n${answer}\n━━━━━━━━━━━━━━━━`, threadID, messageID);
            api.setMessageReaction("✅", messageID, () => {}, true);
        } catch (error) {
            if (typeof loadingMsg !== 'undefined') api.unsendMessage(loadingMsg.messageID);
            api.setMessageReaction("❌", messageID, () => {}, true);
            ...
            return api.sendMessage("❌ XDash is down.", threadID, messageID);
        }
    }
};
